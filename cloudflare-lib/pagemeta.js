...
export const PAGES = {
  ...
  ideas: { title: "Things to ask AI", description: "36 ideas for what to ask an AI: homework help, writing, coding, everyday life, fun and business. Tap one to try it free.", path: "/ideas" },
