...
export default function ShareLink({ url, title }) {
  ...
  return (
    <button
      type="button"
      onClick={share}
      className="ml-1 inline-flex items-center gap-1 rounded-lg bg-white/20 hover:bg-white/30 px-2 py-1 text-xs font-semibold"
    >
