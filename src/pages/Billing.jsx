...
export default function Billing() {
  ...
  const PLANS = {
    secret: {
      ...
      features: ["4 AI's (Opus 5 and Fable 5 in Website Designer)", "5 people total — invite up to 4", "∞ normal AI credits", "∞ AI code credits"],
    ...
    team: {
      ...
      glow: "bg-sky-600/15",
      features: ["4 AI's (Opus 5 and Fable 5 in Website Designer)", "1000 AI code credits", "∞ normal AI credits", "Add up to 2 people — shared credits"],
    ...
    pro: {
      ...
      features: ["3 AI's (incl. Opus 5 in Website Designer)", "100 AI code credits", "∞ normal AI credits"],
