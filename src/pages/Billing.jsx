...
export default function Billing() {
  ...
  const PLANS = {
    secret: {
      ...
      features: ["4 AI's (incl. Galaxy 5 and Space 5 in Website Designer)", "5 people total — invite up to 4", "50 Blackhole AI credits", "25 Blackhole Code credits", "40 Galaxy 5 credits", "25 Space 5 credits"],
    ...
    team: {
      ...
      glow: "bg-sky-600/15",
      features: ["4 AI's (incl. Galaxy 5 and Space 5 in Website Designer)", "25 Blackhole Code credits", "50 Blackhole AI credits", "40 Galaxy 5 credits", "25 Space 5 credits", "Add up to 2 people — shared credits"],
    ...
    pro: {
      ...
      features: ["3 AI's (incl. Galaxy 5 in Website Designer)", "15 Blackhole Code credits", "25 Blackhole AI credits", "25 Galaxy 5 credits"],
