...
export default function Billing() {
  ...
  const PLANS = {
    secret: {
      ...
      features: ["4 AI's (incl. Galaxy 5 and Space 5 in Website Designer)", "5 people total — invite up to 4", "∞ Blackhole AI credits", "∞ Blackhole Code credits", "∞ Galaxy 5 credits", "∞ Space 5 credits"],
