...
export default function Billing() {
  ...
  const PLANS = {
    secret: {
      ...
      features: ["4 AI's (Galaxy 5 and Space 5 in Website Designer)", "5 people total — invite up to 4", "∞ normal AI credits", "∞ Blackhole Code credits"],
    ...
    team: {
      ...
      glow: "bg-sky-600/15",
      features: ["4 AI's (Galaxy 5 and Space 5 in Website Designer)", "1000 Blackhole Code credits", "∞ normal AI credits", "Add up to 2 people — shared credits"],
    ...
    pro: {
      ...
      features: ["3 AI's (incl. Galaxy 5 in Website Designer)", "100 Blackhole Code credits", "∞ normal AI credits"],
