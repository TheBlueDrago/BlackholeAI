...
const POINTS = [
  ...
  { icon: Sparkles, title: "Credits for every seat", text: "Each person gets 100 Blackhole AI, 75 Code, 50 Galaxy and 25 Space credits every month." },
      ...
      <section className="grid lg:grid-cols-2 gap-12 pt-10 sm:pt-16">
        <div>
          ...
          <p className="mt-5 text-slate-400 text-lg">
            Give everyone in your business or organization Blackhole AI, with credits for every seat. Pricing depends on how many people will use it: tell us
